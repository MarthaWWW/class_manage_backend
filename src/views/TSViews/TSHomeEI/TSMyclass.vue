  ...
  <template>
    <div>
      <div class="breadCrumbZone">
        ...
        <el-breadcrumb-item><strong>我的课堂</strong></el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      <div></div>
      <div>请填写教室名称以及借用时间，用于查询教室使用状态。
        ...
        <!-- 教室名称条目 -->
        <el-form-item style='margin-bottom:20px;' label="课程名称" prop="classroom_name" placeholder="请输入教室的名称(楼名称+教室编号）" >
          <el-input v-model="ruleForm.classroom_name"></el-input>
        </el-form-item>

        <!-- 教室教室容量最小值 -->
        <el-form-item style='margin-bottom:20px;' label="课时" prop="classroom_capacity_gte" >
          <el-input v-model="ruleForm.classroom_capacity_gte"></el-input>
        </el-form-item>
        
        <el-form-item  style='margin-bottom:20px;' label="学分" prop="classroom_capacity_lte" >
          <el-input v-model="ruleForm.classroom_capacity_lte"></el-input>
        </el-form-item>

        <el-form-item  style='margin-bottom:20px;' label="学生人数" prop="students_sum_lte" >
    ...
    data() {
      return {
       ...
       options2:[
        ...
        rules: {
          classroom_name: [
            { required: true, message: '请输入教室的名称(楼名称+教室编号）', trigger: 'blur' },
            { min: 2, max: 10, message: '长度在 2 到 10 个字符', trigger: 'blur' }
          ],

           desc: [
            { required: false, message: '请输入借教室原因', trigger: 'blur' },
