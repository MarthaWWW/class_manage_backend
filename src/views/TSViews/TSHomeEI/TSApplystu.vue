<template>
    <div>
      ...
      <div></div>
      <div style="left">请填写教室名称以及借用时间，用于查询教室使用状态。
       </div>
    ...
    <el-form-item label="结束时间" prop="end_timehms" >
     <el-select v-model="ruleForm.value2" placeholder="请选择结束时间"> 
        ...
        <!-- 教室名称条目 -->
        <el-form-item style='margin-bottom:20px;' label="教室名称" prop="classroom_name" placeholder="请输入教学楼名称+教室号" >
        ...
        <!-- 借教室原因 -->
        <el-form-item  style='margin-bottom:20px;' label="借教室原因" prop="desc" >
  ...
  export default {
    ...
    data() {
      return {
        ...
        status:undefined,
        student_id:  this.$store.state.student_id,//借教室人的id
            ...
            this.$router.push(
                {
                  ...
                  path:'/SmartClass/TSHome/TSApply/TSApplystushow',
                });},1000)
